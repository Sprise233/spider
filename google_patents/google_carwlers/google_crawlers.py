...
from google_patents.data_get.get_basic_data import BasicData
from google_patents.data_get.get_image import ImageData
from google_patents.data_get.get_decription import DecriptionData
